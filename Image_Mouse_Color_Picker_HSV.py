...
#When this script is exected directly, main() will be executed.
#Since the name of itself is main

    
#When this script is imported by others, main() will not be executed.
#Since the name of it from others willbe Mouse_Color_Picker_HSV.py, not main
